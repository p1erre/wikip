...
against the outer project repo.
...
Usage:
  uv run python3 .claude/skills/wikip/scripts/wiki-commit.py \\
...
def main() -> int:
    ...
    # --- resolve the OUTER (project) repo from this script's location ---
    script_dir = Path(__file__).resolve().parent
    outer = toplevel(script_dir)
