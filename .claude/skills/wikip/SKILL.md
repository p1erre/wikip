...
7. **Write `pages/papers/<paper-slug>.md`** in Obsidian flavour. Slug = source-dir basename. See [REFERENCE.md](REFERENCE.md) for the paper-page schema.
8. **Update `graph.json`**:
...
10. **Report** to the user: paper page written, concept pages created vs updated, edges added, any orphans/warnings.
