...
```bash
uv run python3 .claude/skills/reconcile-corpora/scripts/reconcile.py scan <wikis-dir>
```
...
Capture the output:
```bash
uv run python3 .claude/skills/reconcile-corpora/scripts/reconcile.py scan <wikis-dir> > /tmp/reconcile_inventory.json
```
...
```bash
uv run python3 .claude/skills/reconcile-corpora/scripts/reconcile.py apply <wikis-dir>
```
...
5. Run `uv run python3 .claude/skills/wikip/scripts/validate.py <corpus-dir>` on the affected corpus
